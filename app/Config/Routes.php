...
$routes->group('api', function ($routes) {
    ...
    $routes->get('productsdata/(:segment)', 'Admin\ProductsApi::productBySlug/$1');
     $routes->get('productsdata/category/(:any)', 'Admin\ProductsApi::productsByCategory/$1');
    ...
    //pisum category api
      ...
      $routes->get('grocery_categories', 'Admin\ProductCategoryApi::index');
    $routes->get('grocery_categories/(:segment)', 'Admin\ProductCategoryApi::index/$1');
    ...
    $routes->get('about-us', 'admin\HomeController::getAboutUsJson');
      $routes->get('our-clients', 'admin\OurClientsApi::index');
});
