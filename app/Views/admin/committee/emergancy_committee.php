...
<div class="page-inner">
    <h2>Emergancy Committee</h2>

    <!-- Hero Section Form -->
    <div class="card mb-4">
        <div class="card-header"><strong>Hero Section</strong></div>
        <div class="card-body">
            <form action="<?= base_url('saveHero_emergency_committee') ?>" method="post" enctype="multipart/form-data">
                ...
                <tbody>
                    <?php foreach ($committee as $i => $mem): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('delete_emergency_committee/' . $mem['id']) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Delete this member?')">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach ?>
                </tbody>
    ...
    <div class="modal fade" id="memberModal" tabindex="-1">
        <div class="modal-dialog">
            <form method="post" action="<?= base_url('saveMember_emergency_committee') ?>" class="modal-content">
