...
<div class="page-inner">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="<?= base_url('saveHerosc_st') ?>" method="post" enctype="multipart/form-data">
                ...
                <tbody>
                    <?php foreach ($committee as $i => $mem): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('deletesc_st/' . $mem['id']) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Delete this member?')">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach ?>
                </tbody>
    ...
    <div class="modal fade" id="memberModal" tabindex="-1">
        <div class="modal-dialog">
            <form method="post" action="<?= base_url('saveMembersc_st') ?>" class="modal-content">
