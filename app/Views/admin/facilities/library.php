...
<div class="page-inner">
    <h2>Library Facility</h2>

    <!-- Hero Section Form -->
    <form action="<?= base_url('saveLibrary') ?>" method="post" enctype="multipart/form-data">
    ...
    <form action="<?= base_url('saveLibrary') ?>" method="post">
    ...
    <form action="<?= base_url('saveLibrary') ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="card mb-4">
            <div class="card-header">Upload Library Images</div>
            <div class="card-body">
                <div class="mb-3">
    ...
    <div class="card mb-4">
        <div class="card-header">Uploaded Library Images</div>
        <div class="card-body d-flex flex-wrap gap-3">
            <?php foreach ($images as $img): ?>
                <div class="text-center">
                    <img src="<?= base_url('uploads/library/' . $img['image']) ?>" height="100" class="rounded shadow-sm"><br>
                    <a href="<?= base_url('deleteLibrary/' . $img['id']) ?>"
