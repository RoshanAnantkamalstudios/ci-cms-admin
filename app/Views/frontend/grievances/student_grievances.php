...
<section class="hero-section py-5 text-center text-white bg-dark">
    <div class="container position-relative">
        <h1 class="display-4 fw-bold" data-aos="zoom-in" data-aos-duration="1000">
            <?= esc($hero['title'] ?? 'Student Grievance Redressal Committee') ?>
        </h1>
        ...
        <?php if (!empty($hero['button_text']) && !empty($hero['button_link'])) : ?>
            <a href="<?= esc($hero['button_link']) ?>" class="btn btn-light btn-lg mt-4 shadow-sm px-5 py-2"
                data-aos="fade-up" data-aos-delay="400" style="font-family: 'Poppins', sans-serif;">
        ...
        <div class="table-responsive">
            <table class="table table-striped table-hover align-middle">
                ...
                <tbody>
                    ...
                    <?php else : ?>
                        <tr>
                            <td colspan="4" class="text-center text-muted">No committee members found.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
